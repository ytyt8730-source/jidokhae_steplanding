...
const faqs = [
  {
    ...
    answer:
      '물론이죠! 지독해 스텝 활동은 업무가 아니라 취미의 연장선입니다. 모임은 주 1회, 스텝 미팅은 월 1~2회 정도로 부담 없이 참여할 수 있어요. 바쁜 주에는 간단히 역할만 수행하면 됩니다. 오히려 일상에 활력을 주는 루틴이 될 거예요.',
  },
  {
  ...
  },
  {
    ...
    answer:
      '네! 선발 즉시 모든 도서 할인과 참가 혜택이 적용됩니다. 협력 서점 15% 할인, 월간 스텝 모임 참가권, 그리고 연말 워크샵 우선 초대까지. 스텝이 되는 순간부터 지독해의 모든 혜택을 누리실 수 있어요.',
  },
]
