    ...
    <section ref={sectionRef} className="py-24 sm:py-32 bg-dark relative overflow-hidden">
      ...
      <div className="relative max-w-2xl mx-auto px-6">
        ...
        <motion.div
          ...
          className="text-left"
        >
          {/* Letter body - 문단별 여백으로 가독성 향상 */}
          <div className="space-y-6 mb-10">
            {LEADER_LETTER_PARAGRAPHS.map((paragraph, idx) => (
              <p key={idx} className="font-serif text-gray-300 text-lg sm:text-xl leading-relaxed whitespace-pre-line">
                {paragraph}
              </p>
            ))}
          </div>
